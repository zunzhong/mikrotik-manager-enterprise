...
```powershell
Start-Process '.\MikroTik-Manager-Enterprise-Setup-5.9.1-x64.exe' `
...
cấu hình để không làm gián đoạn URL hiện tại. Từ bản 5.9.1, installer đọc `mme.env` theo từng cặp
