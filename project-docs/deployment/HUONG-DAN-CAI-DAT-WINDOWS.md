...
```powershell
Start-Process '.\MikroTik-Manager-Enterprise-Setup-6.0.1-x64.exe' `
...
cấu hình để không làm gián đoạn URL hiện tại. Từ bản 6.0.1, installer đọc `mme.env` theo từng cặp
