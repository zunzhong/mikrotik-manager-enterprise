        ...
        {!selected ? (
          ...
          <>
            ...
            <div className="explorer-tabs">
              {['Overview','Interfaces','IP','Routing','Firewall','Services','Hotspot','Radius','Files','Scripts','Scheduler','Backups'].map((tab) => (
                <button key={tab} type="button">{tab}</button>
              ))}
            </div>

            <div className="placeholder-panel">
              <h3>Device Explorer Foundation</h3>
              <p>Next parts will connect these tabs to Inventory, Backup, Compliance and Collector APIs.</p>
            </div>
          </>
        )}
      </section>
